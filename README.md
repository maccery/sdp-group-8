...
This will the start the task runner. After it's started it'll ask which side of the pitch we are. Simply type `left` or `right`, where left
is the side of the pitch as seen by the camera.
